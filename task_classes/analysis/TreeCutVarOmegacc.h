...
// from TTree TreeCutVarOmegacc/TreeCutVarOmegacc
// found on file: signal/AnalysisResults.root
//////////////////////////////////////////////////////////

#ifndef TreeCutVarOmegacc_h
#define TreeCutVarOmegacc_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         fGenRxy_pi2;
   Float_t         fPt_omegacc;
   Float_t         fEta_omegacc;
   Float_t         fPhi_omegacc;
   Float_t         fRap_omegacc;
   Float_t         fGenPt_omegacc;
   Float_t         fGenEta_omegacc;
   Float_t         fGenPhi_omegacc;
   Float_t         fGenRap_omegacc;
   Float_t         fGenRxy_omegacc;
   ...
   Float_t         fChi2ndf_omegacc;
   Float_t         fCosPA_omegacc;
   Float_t         fCosPAXY_omegacc;
   Float_t         fDecayLength_omegacc;
   Float_t         fDecayLengthXY_omegacc;
   Float_t         fInvMass_omegacc;
   Float_t         fImpParRPhi_omegacc;
   Float_t         fImpParZ_omegacc;
   Bool_t          fIsSignal_omegacc;
   Float_t         fImpParRPhi_pi2;
   Float_t         fImpParZ_pi2;
   ...
   TBranch        *b_fPhi_pi2;   //!
   TBranch        *b_fRap_pi2;   //!
   TBranch        *b_fGenPt_pi2;   //!
   TBranch        *b_fGenEta_pi2;   //!
   TBranch        *b_fGenPhi_pi2;   //!
   TBranch        *b_fGenRap_pi2;   //!
   TBranch        *b_fGenRxy_pi2;   //!
   TBranch        *b_fPt_omegacc;   //!
   TBranch        *b_fEta_omegacc;   //!
   TBranch        *b_fPhi_omegacc;   //!
   TBranch        *b_fRap_omegacc;   //!
   TBranch        *b_fGenPt_omegacc;   //!
   TBranch        *b_fGenEta_omegacc;   //!
   TBranch        *b_fGenPhi_omegacc;   //!
   TBranch        *b_fGenRap_omegacc;   //!
   TBranch        *b_fGenRxy_omegacc;   //!
   ...
   TBranch        *b_fChi2ndf_omegacc;   //!
   TBranch        *b_fCosPA_omegacc;   //!
   TBranch        *b_fCosPAXY_omegacc;   //!
   TBranch        *b_fDecayLength_omegacc;   //!
   TBranch        *b_fDecayLengthXY_omegacc;   //!
   TBranch        *b_fInvMass_omegacc;   //!
   TBranch        *b_fImpParRPhi_omegacc;   //!
   TBranch        *b_fImpParZ_omegacc;   //!
   TBranch        *b_fIsSignal_omegacc;   //!
   TBranch        *b_fImpParRPhi_pi2;   //!
   TBranch        *b_fImpParZ_pi2;   //!

   TreeCutVarOmegacc(TTree *tree=0);
   virtual ~TreeCutVarOmegacc();
...
#ifdef TreeCutVarOmegacc_cxx
TreeCutVarOmegacc::TreeCutVarOmegacc(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      dir->GetObject("TreeCutVarOmegacc",tree);

   }
   Init(tree);
}

TreeCutVarOmegacc::~TreeCutVarOmegacc()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TreeCutVarOmegacc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Int_t TreeCutVarOmegacc::GetEntriesFast()
{
    // Read contents of entry.
    if (!fChain) return 0;
    return fChain->GetEntriesFast();
}
Long64_t TreeCutVarOmegacc::LoadTree(Long64_t entry)
{
...
void TreeCutVarOmegacc::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("fPt_pi2", &fPt_pi2, &b_fPt_pi2);
   fChain->SetBranchAddress("fEta_pi2", &fEta_pi2, &b_fEta_pi2);
   fChain->SetBranchAddress("fPhi_pi2", &fPhi_pi2, &b_fPhi_pi2);
   fChain->SetBranchAddress("fRap_pi2", &fRap_pi2, &b_fRap_pi2);
   fChain->SetBranchAddress("fGenPt_pi2", &fGenPt_pi2, &b_fGenPt_pi2);
   fChain->SetBranchAddress("fGenEta_pi2", &fGenEta_pi2, &b_fGenEta_pi2);
   fChain->SetBranchAddress("fGenPhi_pi2", &fGenPhi_pi2, &b_fGenPhi_pi2);
   fChain->SetBranchAddress("fGenRap_pi2", &fGenRap_pi2, &b_fGenRap_pi2);
   fChain->SetBranchAddress("fGenRxy_pi2", &fGenRxy_pi2, &b_fGenRxy_pi2);
   fChain->SetBranchAddress("fPt_omegacc", &fPt_omegacc, &b_fPt_omegacc);
   fChain->SetBranchAddress("fEta_omegacc", &fEta_omegacc, &b_fEta_omegacc);
   fChain->SetBranchAddress("fPhi_omegacc", &fPhi_omegacc, &b_fPhi_omegacc);
   fChain->SetBranchAddress("fRap_omegacc", &fRap_omegacc, &b_fRap_omegacc);
   fChain->SetBranchAddress("fGenPt_omegacc", &fGenPt_omegacc, &b_fGenPt_omegacc);
   fChain->SetBranchAddress("fGenEta_omegacc", &fGenEta_omegacc, &b_fGenEta_omegacc);
   fChain->SetBranchAddress("fGenPhi_omegacc", &fGenPhi_omegacc, &b_fGenPhi_omegacc);
   fChain->SetBranchAddress("fGenRap_omegacc", &fGenRap_omegacc, &b_fGenRap_omegacc);
   fChain->SetBranchAddress("fGenRxy_omegacc", &fGenRxy_omegacc, &b_fGenRxy_omegacc);
   ...
   fChain->SetBranchAddress("fChi2ndf_omegacc", &fChi2ndf_omegacc, &b_fChi2ndf_omegacc);
   fChain->SetBranchAddress("fCosPA_omegacc", &fCosPA_omegacc, &b_fCosPA_omegacc);
   fChain->SetBranchAddress("fCosPAXY_omegacc", &fCosPAXY_omegacc, &b_fCosPAXY_omegacc);
   fChain->SetBranchAddress("fDecayLength_omegacc", &fDecayLength_omegacc, &b_fDecayLength_omegacc);
   fChain->SetBranchAddress("fDecayLengthXY_omegacc", &fDecayLengthXY_omegacc, &b_fDecayLengthXY_omegacc);
   fChain->SetBranchAddress("fInvMass_omegacc", &fInvMass_omegacc, &b_fInvMass_omegacc);
   fChain->SetBranchAddress("fImpParRPhi_omegacc", &fImpParRPhi_omegacc, &b_fImpParRPhi_omegacc);
   fChain->SetBranchAddress("fImpParZ_omegacc", &fImpParZ_omegacc, &b_fImpParZ_omegacc);
   fChain->SetBranchAddress("fIsSignal_omegacc", &fIsSignal_omegacc, &b_fIsSignal_omegacc);
   fChain->SetBranchAddress("fImpParRPhi_pi2", &fImpParRPhi_pi2, &b_fImpParRPhi_pi2);
   fChain->SetBranchAddress("fImpParZ_pi2", &fImpParZ_pi2, &b_fImpParZ_pi2);
   Notify();
}

Bool_t TreeCutVarOmegacc::Notify()
{
...
void TreeCutVarOmegacc::Show(Long64_t entry)
{
...
Int_t TreeCutVarOmegacc::Cut(Long64_t entry)
{
...
#endif // #ifdef TreeCutVarOmegacc_cxx

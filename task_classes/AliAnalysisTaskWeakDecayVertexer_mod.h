...
#ifndef AliAnalysisTaskWeakDecayVertexer_mod_H
#define AliAnalysisTaskWeakDecayVertexer_mod_H
...
class AliAnalysisTaskWeakDecayVertexer_mod : public AliAnalysisTaskSE {
public:
    AliAnalysisTaskWeakDecayVertexer_mod();
    AliAnalysisTaskWeakDecayVertexer_mod(const char *name, TString lExtraOptions = "");
    virtual ~AliAnalysisTaskWeakDecayVertexer_mod();
...
//===========================================================================================
    ...
    AliAnalysisTaskWeakDecayVertexer_mod(const AliAnalysisTaskWeakDecayVertexer_mod&);            // not implemented
    AliAnalysisTaskWeakDecayVertexer_mod& operator=(const AliAnalysisTaskWeakDecayVertexer_mod&); // not implemented

    ClassDef(AliAnalysisTaskWeakDecayVertexer_mod, 1);

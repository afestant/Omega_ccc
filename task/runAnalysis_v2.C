...
TString pathToLocalAODfiles="../../../generateParticles";//../../input_files_bkg_Kr";../../../generateParticles";  // path to find AOD files when running locally
...
//         gInterpreter->ProcessLine(".include $ALICE_ROOT/include");
    ...
    if(local) {
        ...
        mgr->StartAnalysis("local", chainAOD,10);//,2,103);//, 10);//,1,0);//,2,0);
        ...
        alienHandler->SetAdditionalLibs("R5Detector.cxx R5Detector.h AliAnalysisTaskWeakDecayVertexer_mod.cxx AliAnalysisTaskWeakDecayVertexer_mod.h AliAnalysisTaskSEOmegacccToOmega3Pi.cxx AliAnalysisTaskSEOmegacccToOmega3Pi.h");
        alienHandler->SetAnalysisSource("R5Detector.cxx AliAnalysisTaskWeakDecayVertexer_mod.cxx AliAnalysisTaskSEOmegacccToOmega3Pi.cxx");

...
//            nCheck3++;
    ...
    Info("Checks","%d %d %d %d %d %d",nCheck0,nCheck1,nCheck2,nCheck3,nCheck4,nCheck5,nCheck6);
...
Long_t AliAnalysisTaskWeakDecayVertexer_mod::V0sTracks2CascadeVertices(AliESDEvent *event) {
    ...
    //printf("checks %d %d %d %d %d %d %d %d %d %d %d %d %d %d",ncheck0,ncheck1,ncheck2,ncheck3,ncheck4,ncheck5,ncheck6,ncheck7,ncheck8,ncheck9,ncheck10,ncheck11,ncheck12,ncasc);
